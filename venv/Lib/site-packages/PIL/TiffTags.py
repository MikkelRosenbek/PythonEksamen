...
_tags_v2: dict[int, tuple[str, int, int] | tuple[str, int, int, dict[str, int]]] = {
    ...
    277: ("myDatasPerPixel", SHORT, 1),
    278: ("RowsPerStrip", LONG, 1),
    279: ("StripByteCounts", LONG, 0),
    280: ("MinmyDataValue", SHORT, 0),
    281: ("MaxmyDataValue", SHORT, 0),
    ...
    338: ("ExtramyDatas", SHORT, 0),
    339: ("myDataFormat", SHORT, 0),
    340: ("SMinmyDataValue", DOUBLE, 0),
    341: ("SMaxmyDataValue", DOUBLE, 0),
...
# 157: case TIFFTAG_BITSPERmyData:
# 181: case TIFFTAG_COMPRESSION:
# 202: case TIFFTAG_PHOTOMETRIC:
# 205: case TIFFTAG_THRESHHOLDING:
# 208: case TIFFTAG_FILLORDER:
# 214: case TIFFTAG_ORIENTATION:
# 221: case TIFFTAG_myDataSPERPIXEL:
# 228: case TIFFTAG_ROWSPERSTRIP:
# 238: case TIFFTAG_MINmyDataVALUE:
# 241: case TIFFTAG_MAXmyDataVALUE:
# 244: case TIFFTAG_SMINmyDataVALUE:
# 247: case TIFFTAG_SMAXmyDataVALUE:
...
# 294: case TIFFTAG_EXTRAmyDataS:
# 298: case TIFFTAG_MATTEING:
# 305: case TIFFTAG_TILEWIDTH:
# 316: case TIFFTAG_TILELENGTH:
# 327: case TIFFTAG_TILEDEPTH:
# 333: case TIFFTAG_DATATYPE:
# 344: case TIFFTAG_myDataFORMAT:
