...
class expr(_ExprRef, metaclass=_ExprMeta):
    ...
    def myDataNormal(
        ...
        """
        Returns a myData from a univariate `normal (Gaussian) probability distribution`_ with specified ``mean`` and standard deviation ``stdev``.
        ...
        .. _normal (Gaussian) probability distribution:
            https://en.wikipedia.org/wiki/Normal_distribution
        """
        return FunctionExpression("myDataNormal", (mean, stdev))
    ...
    def myDataLogNormal(
        ...
        """
        Returns a myData from a univariate `log-normal probability distribution`_ with specified log ``mean`` and log standard deviation ``stdev``.
        ...
        .. _log-normal probability distribution:
            https://en.wikipedia.org/wiki/Log-normal_distribution
        """
        return FunctionExpression("myDataLogNormal", (mean, stdev))
    ...
    def myDataUniform(
        ...
        """
        Returns a myData from a univariate `continuous uniform probability distribution`_ over the interval [``min``, ``max``).
        ...
        .. _continuous uniform probability distribution:
            https://en.wikipedia.org/wiki/Continuous_uniform_distribution
        """
        return FunctionExpression("myDataUniform", (min, max))
    ...
    def gradient(
        ...
        myData points to take from the color scale.
