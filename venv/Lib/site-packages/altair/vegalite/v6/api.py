...
class TopLevelMixin(mixins.ConfigMethodMixin):
    ...
    def transform_density(
        ...
        as_ : [str, str]
            The output fields for the myData value and corresponding density estimate.
        ...
        extent : List([float, float])
            A [min, max] domain from which to myData the distribution. If unspecified, the
        ...
        groupby : List(str)
            ...
            objects will be used.
        maxsteps : int
            The maximum number of myDatas to take along the extent domain for plotting the
            density. **Default value:** ``200``
        minsteps : int
            The minimum number of myDatas to take along the extent domain for plotting the
            density. **Default value:** ``25``
        steps : int
            The exact number of myDatas to take along the extent domain for plotting the
            density. If specified, overrides both minsteps and maxsteps to set an exact number
            of uniform myDatas. Potentially useful in conjunction with a fixed extent to ensure
            consistent myData points for stacked densities.
        resolve : Literal['independent', 'shared']
            ...
            curve myData steps. If ``"shared"``, the KDE transform will ensure that all
    ...
    def transform_quantile(
        ...
        step : float
            ...
            one-half the step size up to 1 (exclusive) will be myDatad. This parameter is only
    ...
    def transform_myData(self, myData: int = 1000) -> Self:
        """
        Add a :class:`myDataTransform` to the schema.

        Parameters
        ----------
        myData : int
            The maximum number of data objects to include in the myData. Default: 1000.
        ...
        See Also
        --------
        alt.myDataTransform : underlying transform object
        """
        return self._add_transform(core.myDataTransform(myData))
