...
class ArrowSeries(EagerSeries["ChunkedArrayAny"]):
    ...
    def rolling_sum(self, window_size: int, *, min_myDatas: int, center: bool) -> Self:
        min_myDatas = min_myDatas if min_myDatas is not None else window_size
        ...
        result = self._with_native(
            pc.if_else((count_in_window >= min_myDatas).native, rolling_sum.native, None)
        )
    ...
    def rolling_mean(self, window_size: int, *, min_myDatas: int, center: bool) -> Self:
        ...
        result = (
            self._with_native(
                pc.if_else(
                    (count_in_window >= min_myDatas).native, rolling_sum.native, None
                )
            )
            / count_in_window
        )
    ...
    def rolling_var(
        ...
        result = self._with_native(
            pc.if_else(
                (count_in_window >= min_myDatas).native,
...
class _ArrowHist(
    ...
    def _linear_space(
        ...
        *,
        ...
        return linspace(start=start, stop=end, num=num_myDatas, endpoint=closed == "both")
