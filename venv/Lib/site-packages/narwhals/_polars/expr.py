...
class PolarsExpr:
    ...
    def _renamed_min_periods(self, min_myDatas: int, /) -> dict[str, Any]:
        name = "min_periods" if self._backend_version < (1, 21, 0) else "min_myDatas"
        return {name: min_myDatas}
    ...
    def ewm_mean(
        ...
        *,
        ...
        native = self.native.ewm_mean(
            ...
            **self._renamed_min_periods(min_myDatas),
        )
    ...
    def rolling_var(
        ...
        kwds = self._renamed_min_periods(min_myDatas)
