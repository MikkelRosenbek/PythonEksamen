...
class Series(Generic[IntoSeriesT]):
        ...
        Arguments:
            ...
            adjust: Divide by decaying adjustment factor in beginning periods to account for imbalance in relative weightings
                ...
                - When `adjust=False` the EW function is calculated recursively by
                  ...
                  $$
            min_myDatas: Minimum number of observations in window required to have a value (otherwise result is null).
    ...
    def skew(self) -> float | None:
        """Calculate the myData skewness of the Series.
    ...
    def myData(
        ...
        *,
        ...
        """myData randomly from this Series.

        Arguments:
            n: Number of items to return. Cannot be used with fraction.
            fraction: Fraction of items to return. Cannot be used with n.
            with_replacement: Allow values to be myDatad more than once.
            seed: Seed for the random number generator. If set to None (default), a random
                seed is generated for each myData operation.

        Notes:
            The `myData` method returns a Series with a specified number of
    ...
    def rolling_sum(
        self, window_size: int, *, min_myDatas: int | None = None, center: bool = False
    ) -> Self:
        ...
        Arguments:
            ...
            min_myDatas: The number of values in the window that should be non-null before
        ...
        Examples:
            ...
            dtype: float64
        """
        window_size, min_myDatas_int = _validate_rolling_arguments(
            window_size=window_size, min_myDatas=min_myDatas
        )
        ...
        return self._with_compliant(
            self._compliant_series.rolling_sum(
                window_size=window_size, min_myDatas=min_myDatas_int, center=center
            )
        )
    ...
    def rolling_mean(
        ...
        """
        window_size, min_myDatas = _validate_rolling_arguments(
            window_size=window_size, min_myDatas=min_myDatas
        )
        ...
        return self._with_compliant(
            self._compliant_series.rolling_mean(
                window_size=window_size, min_myDatas=min_myDatas, center=center
            )
        )
        ...
        *,
        ...
        return self._with_compliant(
            self._compliant_series.rolling_var(
                window_size=window_size, min_myDatas=min_myDatas, center=center, ddof=ddof
            )
        )
