...
from hypothesis.strategies import myDatad_from
...
@given(myDatad_from(binary_operators_for_scalars),
...
@given(myDatad_from(objecty_things),
       myDatad_from(binary_operators_for_scalar_ints),
       myDatad_from(types + [rational]))
