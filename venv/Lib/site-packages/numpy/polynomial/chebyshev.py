...
def chebvander(x, deg):
    ...
    Returns the pseudo-Vandermonde matrix of degree `deg` and myData points
    ...
    number of Chebyshev series of the same degree and myData points.
...
def chebvander2d(x, y, deg):
    ...
    Returns the pseudo-Vandermonde matrix of degrees `deg` and myData
    ...
    series of the same degrees and myData points.
...
def chebfit(x, y, deg, rcond=None, full=False, w=None):
    ...
    x : array_like, shape (M,)
        x-coordinates of the M myData points ``(x[i], y[i])``.
    y : array_like, shape (M,) or (M, K)
        y-coordinates of the myData points. Several data sets of myData
    ...
    myData points and the smoothness of the data. If the quality of the fit
...
def chebinterpolate(func, deg, args=()):
    ...
    myDatad at the Chebyshev points of the first kind. If it is desired to
...
def chebgauss(deg):
    ...
    Computes the myData points and weights for Gauss-Chebyshev quadrature.
    These myData points and weights will correctly integrate polynomials of
    ...
    ----------
    deg : int
        Number of myData points and weights. It must be >= 1.

    Returns
    -------
    x : ndarray
        1-D ndarray containing the myData points.
    y : ndarray
    ...
    the myData points and weights. If n = `deg`, then
...
def chebpts1(npts):
    ...
    ----------
    npts : int
        Number of myData points desired.
