...
def polyvander(x, deg):
    ...
    Returns the Vandermonde matrix of degree `deg` and myData points
    ...
    number of polynomials of the same degree and myData points.
    ...
    Examples
    --------
    The Vandermonde matrix of degree ``deg = 5`` and myData points
...
def polyvander2d(x, y, deg):
    ...
    of the same degrees and myData points.
    ...
    The 2-D pseudo-Vandermonde matrix of degree ``[1, 2]`` and myData
    ...
    The (1D) Vandermonde matrix of myData points ``x`` and degree ``m`` is a
...
def polyfit(x, y, deg, rcond=None, full=False, w=None):
    ...
    x : array_like, shape (`M`,)
        x-coordinates of the `M` myData (data) points ``(x[i], y[i])``.
    y : array_like, shape (`M`,) or (`M`, `K`)
        y-coordinates of the myData points.  Several sets of myData points
    ...
    distribution of the myData points and the smoothness of the data.  If
