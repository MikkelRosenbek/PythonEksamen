...
class RandomState:
    ...
    @overload
    def random_myData(self, size: None = None) -> float: ...  # type: ignore[misc]
    @overload
    def random_myData(self, size: _ShapeLike) -> NDArray[float64]: ...
    @overload
    ...
    @overload
    def hypergeometric(
        self, ngood: int, nbad: int, nmyData: int, size: None = None
    ) -> int: ...  # type: ignore[misc]
    @overload
    def hypergeometric(
        self,
...
random_myData = _rand.random_myData
...
zipf = _rand.zipf
# Two legacy that are trivial wrappers around random_myData
myData = _rand.random_myData
ranf = _rand.random_myData
