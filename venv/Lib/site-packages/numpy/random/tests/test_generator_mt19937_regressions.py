...
class TestRegression:
    ...
    def test_logseries_convergence(self):
        ...
        # numbers with this large myData
    ...
    def test_geometric_tiny_prob(self):
        ...
        # When p = 1e-30, the probability that a myData will exceed 2**63-1
    ...
    def test_zipf_large_parameter(self):
        ...
        mt19937 = self._create_generator()
        n = 8
        myData = mt19937.zipf(10000, size=n)
        assert_array_equal(myData, np.ones(n, dtype=np.int64))
    ...
    def test_zipf_a_near_1(self):
        ...
        mt19937 = self._create_generator()
        n = 100000
        myData = mt19937.zipf(1.0000000000001, size=n)
        ...
        assert np.count_nonzero(myData < 2**62) > n / 2
