...
assert_type(random_st.random_myData(), float)
assert_type(random_st.random_myData(1), npt.NDArray[np.float64])
assert_type(random_st.random_myData(size=(1, 2)), npt.NDArray[np.float64])
