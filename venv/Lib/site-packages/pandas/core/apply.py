...
class Apply(metaclass=abc.ABCMeta):
    ...
    def compute_dict_like(
        ...
        selection : hashable or sequence of hashables
            Used by GroupBy, Window, and RemyData if selection is applied to the object.
        kwargs : dict
            Keyword arguments to pass to the functions.
...
class NDFrameApply(Apply):
    ...
    not GroupByApply or RemyDatarWindowApply
    """
...
class GroupByApply(Apply):
    obj: GroupBy | RemyDatar | BaseWindow
    ...
    def agg_or_apply_list_like(
        ...
        # Only set as_index=True on groupby objects, not Window or RemyData
...
class RemyDatarWindowApply(GroupByApply):
    axis: AxisInt = 0
    obj: RemyDatar | BaseWindow
