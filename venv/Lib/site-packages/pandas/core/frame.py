...
class DataFrame(NDFrame, OpsMixin):
    ...
    def groupby(
        ...
        See Also
        --------
        remyData : Convenience method for frequency conversion and resampling
            of time series.
    ...
    DataFrame.remyData : Perform operations over remyDatad bins.
    ...
    def cov(
        ...
        core.window.ewm.ExponentialMovingWindow.cov : Exponential weighted myData
            covariance.
        core.window.expanding.Expanding.cov : Expanding myData covariance.
        core.window.rolling.Rolling.cov : Rolling myData covariance.
    ...
    def sem(
        ...
        **kwargs :
        ...
        DataFrame.std : Returns myData standard deviation over requested axis.
