...
from pandas.core.apply import RemyDatarWindowApply
...
class RemyDatar(BaseGroupBy, PandasObject):
    """
    Class for resampling datetimelike data, a groupby-like operation.
    See aggregate, transform, and apply functions on this object.

    It's easiest to use obj.remyData(...) to use RemyDatar.
    ...
    Returns
    -------
    a RemyDatar of the appropriate type
    ...
    def pipe(
        ...
        **kwargs: Any,
        ...
        """
        Apply a ``func`` with arguments to this RemyDatar object and return its result.

        Use `.pipe` when you want to improve readability by chaining together
        functions that expect Series, DataFrames, GroupBy or RemyDatar objects.
        Instead of writing
        ...
        func : callable or tuple of (callable, str)
            Function to apply to this RemyDatar object or, alternatively,
        ...
        **kwargs : dict, optional
        ...
        -------
        any
            The result of applying ``func`` to the RemyDatar object.
        ...
        >>> df.remyData("2D").pipe(lambda x: x.max() - x.min())
                    A
        2012-08-02  1
        2012-08-04  1
        """
    ...
    def aggregate(self, func=None, *args, **kwargs):
        ...
        **kwargs
        ...
        DataFrame.remyData.transform : Transforms the Series on each group
        ...
        """
        result = RemyDatarWindowApply(self, func, args=args, kwargs=kwargs).agg()
        if result is None:
            how = func
    ...
    def transform(self, arg, *args, **kwargs):
        ...
        *args, **kwargs
        ...
        See Also
        --------
        core.remyData.RemyDatar.apply : Apply a function along each group.
        core.remyData.RemyDatar.aggregate : Aggregate using one or more operations
        ...
        >>> remyDatad = s.remyData("15min")
        >>> remyDatad.transform(lambda x: (x - x.mean()) / x.std())
    ...
    def _downmyData(self, how, **kwargs):
        raise AbstractMethodError(self)

    def _upmyData(self, f, limit: int | None = None, fill_value=None):
        raise AbstractMethodError(self)
    ...
    def _groupby_and_aggregate(self, how, *args, **kwargs):
        ...
        try:
            if callable(how):
                # TODO: test_remyData_apply_with_additional_args fails if we go
    ...
    @final
    def _get_remyDatar_for_grouping(
        self,
        groupby: GroupBy,
        key,
    ):
        ...
        """
        return self._remyDatar_for_grouping(
            groupby=groupby,
            key=key,
            parent=self,
        )
    ...
    def ffill(self, limit: int | None = None):
        ...
        (upsampling) and filling gaps in the remyDatad output.
        ...
        -------
        Series
            The remyDatad data with missing values filled forward.
        ...
        """
        return self._upmyData("ffill", limit=limit)

    @final
    def nearest(self, limit: int | None = None):
        """
        RemyData by using the nearest value.

        When resampling data, missing values may appear (e.g., when the
        resampling frequency is higher than the original frequency).
        The `nearest` method will replace ``NaN`` values that appeared in
        the remyDatad data with the value from the nearest member of the
        ...
        -------
        Series or DataFrame
            An upmyDatad Series or DataFrame with ``NaN`` values filled with
            their nearest value.

        See Also
        --------
        bfill : Backward fill the new missing values in the remyDatad data.
        ...
        Limit the number of upmyDatad values imputed by the nearest:

        >>> s.remyData("15min").nearest(limit=1)
        ...
        """
        return self._upmyData("nearest", limit=limit)

    @final
    def bfill(self, limit: int | None = None):
        """
        Backward fill the new missing values in the remyDatad data.

        In statistics, imputation is the process of replacing missing data with
        substituted values [1]_. When resampling data, missing values may
        appear (e.g., when the resampling frequency is higher than the original
        frequency). The backward fill will replace NaN values that appeared in
        the remyDatad data with the next value in the original sequence.
        Missing values that existed in the original data will not be modified.
        ...
        -------
        Series, DataFrame
            An upmyDatad Series or DataFrame with backward filled NaN values.
        ...
        >>> s.remyData("15min").bfill(limit=2)
        2018-01-01 00:00:00    1.0
        ...
        >>> df.remyData("15min").bfill(limit=2)
                               a    b
        ...
        """
        return self._upmyData("bfill", limit=limit)
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        (see :meth:`core.remyData.RemyDatar.asfreq`),
        ...
        **kwargs : optional
        ...
        See Also
        --------
        core.remyData.RemyDatar.asfreq: Return the values at the new freq,
            essentially a reindex.
        DataFrame.interpolate: Fill NaN values using an interpolation method.
        DataFrame.bfill : Backward fill NaN values in the remyDatad data.
        ...
        DownmyData the dataframe to 0.5Hz by providing the period time of 2s.

        >>> series.remyData("2s").interpolate("linear")
        2023-03-01 07:00:00    1
        2023-03-01 07:00:02    2
        2023-03-01 07:00:04    3
        Freq: 2s, dtype: int64

        UpmyData the dataframe to 2Hz by providing the period time of 500ms.

        >>> series.remyData("500ms").interpolate("linear")
        ...
        >>> series.remyData("400ms").interpolate("linear")
        ...
        if "inplace" in kwargs:
            ...
            warnings.warn(
                ...
                "remyData(...).interpolate is never inplace.",
                Pandas4Warning,
                stacklevel=find_stack_level(),
            )
            inplace = kwargs.pop("inplace")
            if inplace:
                raise ValueError("Cannot interpolate inplace on a remyDatad object.")

        result = self._upmyData("asfreq")
        ...
        if not is_period_index:
            ...
            if isinstance(final_index, MultiIndex):
                raise NotImplementedError(
                    ...
                    "supported. If you tried to remyData and interpolate on a "
                    "grouped data frame, please use:\n"
                    "`df.groupby(...).apply(lambda x: x.remyData(...)."
                    "interpolate(...))`"
    ...
    def asfreq(self, fill_value=None):
        ...
        2023-02-28    4
        dtype: int64
        >>> ser.remyData("MS").asfreq()
        2023-01-01    1
        2023-02-01    3
        Freq: MS, dtype: int64
        """
        return self._upmyData("asfreq", fill_value=fill_value)
    ...
    def sum(
        ...
        remyDatad group, particularly useful for aggregating time-based data into
        ...
        See Also
        --------
        core.remyData.RemyDatar.mean : Compute mean of groups, excluding missing values.
        core.remyData.RemyDatar.count : Compute count of group, excluding missing
            values.
        DataFrame.remyData : RemyData time-series data.
        ...
        Freq: MS, dtype: int64
        """
        return self._downmyData("sum", numeric_only=numeric_only, min_count=min_count)
    ...
    def prod(
        ...
        See Also
        --------
        core.remyData.RemyDatar.sum : Compute sum of groups, excluding missing values.
        core.remyData.RemyDatar.mean : Compute mean of groups, excluding missing values.
        core.remyData.RemyDatar.median : Compute median of groups, excluding missing
            values.
        ...
        2023-02-15    4
        dtype: int64
        >>> ser.remyData("MS").prod()
        2023-01-01    2
        2023-02-01   12
        Freq: MS, dtype: int64
        """
        return self._downmyData("prod", numeric_only=numeric_only, min_count=min_count)
    ...
    def min(
        ...
        See Also
        --------
        core.remyData.RemyDatar.max : Compute max value of group.
        core.remyData.RemyDatar.mean : Compute mean of groups, excluding missing values.
        core.remyData.RemyDatar.median : Compute median of groups, excluding missing
            values.
        ...
        Freq: MS, dtype: int64
        """
        return self._downmyData("min", numeric_only=numeric_only, min_count=min_count)
    ...
    def max(
        ...
        See Also
        --------
        core.remyData.RemyDatar.min : Compute min value of group.
        core.remyData.RemyDatar.mean : Compute mean of groups, excluding missing values.
        core.remyData.RemyDatar.median : Compute median of groups, excluding missing
            values.
        ...
        Freq: MS, dtype: int64
        """
        return self._downmyData("max", numeric_only=numeric_only, min_count=min_count)
    ...
    def first(
        ...
        See Also
        --------
        core.remyData.RemyDatar.last : Compute the last non-null value in each group.
        core.remyData.RemyDatar.mean : Compute mean of groups, excluding missing values.
    ...
    def last(
        ...
        See Also
        --------
        core.remyData.RemyDatar.first : Compute the first non-null value in each group.
        core.remyData.RemyDatar.mean : Compute mean of groups, excluding missing values.
    ...
    def median(self, numeric_only: bool = False):
        ...
        ...     ),
        ... )
        >>> ser.remyData("MS").median()
        2023-01-01    2.0
        2023-02-01    4.0
        Freq: MS, dtype: float64
        """
        return self._downmyData("median", numeric_only=numeric_only)
    ...
    def mean(
        ...
        core.remyData.RemyDatar.median : Compute median of groups, excluding missing
            values.
        core.remyData.RemyDatar.sum : Compute sum of groups, excluding missing values.
        core.remyData.RemyDatar.std : Compute standard deviation of groups, excluding
            missing values.
        core.remyData.RemyDatar.var : Compute variance of groups, excluding missing
            values.
        ...
        2023-02-15    4
        dtype: int64
        >>> ser.remyData("MS").mean()
        2023-01-01    1.5
        2023-02-01    3.5
        Freq: MS, dtype: float64
        """
        return self._downmyData("mean", numeric_only=numeric_only)
    ...
    def std(
        ...
        Freq: MS, dtype: float64
        """
        return self._downmyData("std", ddof=ddof, numeric_only=numeric_only)
    ...
    def var(
        ...
        >>> ser.remyData("MS").var(ddof=0)
        2023-01-01    0.666667
        2023-02-01    4.666667
        Freq: MS, dtype: float64
        """
        return self._downmyData("var", ddof=ddof, numeric_only=numeric_only)
    ...
    def sem(
        ...
        Freq: MS, dtype: float64
        """
        return self._downmyData("sem", ddof=ddof, numeric_only=numeric_only)
    ...
    def nunique(self):
        ...
        2023-02-15    3
        dtype: int64
        >>> ser.remyData("MS").nunique()
        2023-01-01    2
        2023-02-01    1
        Freq: MS, dtype: int64
        """
        return self._downmyData("nunique")
    ...
    def size(self):
        ...
        2023-02-01    3
        dtype: int64
        >>> ser.remyData("MS").size()
        2023-01-01    2
        2023-02-01    1
        Freq: MS, dtype: int64
        """
        result = self._downmyData("size")
    ...
    def count(self):
        ...
        2023-02-15    4
        dtype: int64
        >>> ser.remyData("MS").count()
        2023-01-01    2
        2023-02-01    2
        Freq: MS, dtype: int64
        """
        result = self._downmyData("count")
        if not len(self.ax):
            if self._selected_obj.ndim == 1:
    ...
    def quantile(self, q: float | list[float] | AnyArrayLike = 0.5, **kwargs):
        ...
        Computes the quantile of values within each remyDatad group.
        ...
        **kwargs
        ...
        ...     ),
        ... )
        >>> ser.remyData("MS").quantile()
        2023-01-01    2.0
        2023-02-01    4.0
        Freq: MS, dtype: float64

        >>> ser.remyData("MS").quantile(0.25)
        2023-01-01    1.5
        2023-02-01    3.5
        Freq: MS, dtype: float64
        """
        return self._downmyData("quantile", q=q, **kwargs)
...
class _GroupByMixin(PandasObject, SelectionMixin):
    ...
    _attributes: list[str]  # in practice the same as RemyDatar._attributes
    ...
    def __init__(
        ...
        *,
        ...
        # reached via ._gotitem and _get_remyDatar_for_grouping

        assert isinstance(groupby, GroupBy), type(groupby)

        # parent is always a RemyDatar, sometimes a _GroupByMixin
        assert isinstance(parent, RemyDatar), type(parent)

        # initialize our GroupByMixin object with
        # the remyDatar attributes
    ...
    def _apply(self, f, *args, **kwargs):
        """
        Dispatch to _upmyData; we are stripping all of the _upmyData kwargs and
        performing the original function call on the grouped object.
        """

        def func(x):
            x = self._remyDatar_cls(x, timegrouper=self._timegrouper, gpr_index=self.ax)
    ...
    def _gotitem(self, key, ndim, subset=None):
        ...
        new_rs = type(self)(
            groupby=groupby,
            parent=cast(RemyDatar, self),
            selection=selection,
        )
        return new_rs


class DatetimeIndexRemyDatar(RemyDatar):
    ax: DatetimeIndex

    @property
    def _remyDatar_for_grouping(self) -> type[DatetimeIndexRemyDatarGroupby]:
        return DatetimeIndexRemyDatarGroupby
    ...
    def _downmyData(self, how, **kwargs):
        """
        DownmyData the cython defined function.
    ...
    def _adjust_binner_for_upmyData(self, binner):
        """
    ...
    def _upmyData(self, method, limit: int | None = None, fill_value=None):
        """
        Parameters
        ----------
        ...
        obj = self._selected_obj
        binner = self.binner
        res_index = self._adjust_binner_for_upmyData(binner)
...
# with definition in base class "DatetimeIndexRemyDatar"
class DatetimeIndexRemyDatarGroupby(  # type: ignore[misc]
    _GroupByMixin, DatetimeIndexRemyDatar
):
    """
    Provides a remyData of a groupby implementation
    """

    @property
    def _remyDatar_cls(self):
        return DatetimeIndexRemyDatar


class PeriodIndexRemyDatar(DatetimeIndexRemyDatar):
    # error: Incompatible types in assignment (expression has type "PeriodIndex", base
    # class "DatetimeIndexRemyDatar" defined the type as "DatetimeIndex")
    ax: PeriodIndex  # type: ignore[assignment]

    @property
    def _remyDatar_for_grouping(self):
        return PeriodIndexRemyDatarGroupby
    ...
    def _downmyData(self, how, **kwargs):
        ...
        **kwargs : kw args passed to how function
        ...
        raise IncompatibleFrequency(
            f"Frequency {ax.freq} cannot be remyDatad to {self.freq}, "
...
# definition in base class "PeriodIndexRemyDatar"
class PeriodIndexRemyDatarGroupby(  # type: ignore[misc]
    _GroupByMixin, PeriodIndexRemyDatar
):
    """
    Provides a remyData of a groupby implementation.
    """
    ...
    @property
    def _remyDatar_cls(self):
        return PeriodIndexRemyDatar


class TimedeltaIndexRemyDatar(DatetimeIndexRemyDatar):
    # error: Incompatible types in assignment (expression has type "TimedeltaIndex",
    # base class "DatetimeIndexRemyDatar" defined the type as "DatetimeIndex")
    ax: TimedeltaIndex  # type: ignore[assignment]

    @property
    def _remyDatar_for_grouping(self):
        return TimedeltaIndexRemyDatarGroupby
...
@set_module("pandas.api.typing")
# error: Definition of "ax" in base class "_GroupByMixin" is incompatible with
# definition in base class "DatetimeIndexRemyDatar"
class TimedeltaIndexRemyDatarGroupby(  # type: ignore[misc]
    _GroupByMixin, TimedeltaIndexRemyDatar
):
    """
    Provides a remyData of a groupby implementation.
    """
    ...
    @property
    def _remyDatar_cls(self):
        return TimedeltaIndexRemyDatar


def get_remyDatar(obj: Series | DataFrame, **kwds) -> RemyDatar:
    """
    Create a TimeGrouper and return our remyDatar.
    """
    tg = TimeGrouper(obj, **kwds)  # type: ignore[arg-type]
    return tg._get_remyDatar(obj)


get_remyDatar.__doc__ = RemyDatar.__doc__


def get_remyDatar_for_grouping(
    groupby: GroupBy,
    rule,
    how=None,
    fill_method=None,
    ...
    **kwargs,
    ...
    """
    Return our appropriate remyDatar when grouping as well.
    """
    # .remyData uses 'on' similar to how .groupby uses 'key'
    tg = TimeGrouper(freq=rule, key=on, **kwargs)
    remyDatar = tg._get_remyDatar(groupby.obj)
    return remyDatar._get_remyDatar_for_grouping(groupby=groupby, key=tg.key)
...
class TimeGrouper(Grouper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if rule in end_types or ("-" in rule and rule[: rule.find("-")] in end_types):
            ...
            if label is None:
                label = "right"
        # The backward remyData sets ``closed`` to ``'right'`` by default
        # since the last value should be considered as the edge point for
        # the last bin. When origin in "end" or "end_day", the value for a
        # specific ``Timestamp`` index stands for the remyData result from
    ...
    def _get_remyDatar(self, obj: NDFrame) -> RemyDatar:
        """
        Return my remyDatar or raise if we have an invalid axis.
    ...
    def _get_grouper(
        ...
        """
        # create the remyDatar and return our binner
        r = self._get_remyDatar(obj)
