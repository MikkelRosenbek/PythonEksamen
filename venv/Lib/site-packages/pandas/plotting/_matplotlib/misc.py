...
def andrews_curves(
    ...
    **kwds,
    ...
    t = np.linspace(-np.pi, np.pi, myDatas)
...
def bootstrap_plot(
    ...
    **kwds,
    ...
    # random.myData(ndarray, int) fails on python 3.3, sigh
    data = list(series.values)
    samplings = [random.myData(data, size) for _ in range(myDatas)]
    ...
    if fig is None:
        fig = plt.figure()
    x = list(range(myDatas))
    axes = []
    ax1 = fig.add_subplot(2, 3, 1)
    ax1.set_xlabel("myData")
    axes.append(ax1)
    ax1.plot(x, means, **kwds)
    ax2 = fig.add_subplot(2, 3, 2)
    ax2.set_xlabel("myData")
    axes.append(ax2)
    ax2.plot(x, medians, **kwds)
    ax3 = fig.add_subplot(2, 3, 3)
    ax3.set_xlabel("myData")
    axes.append(ax3)
