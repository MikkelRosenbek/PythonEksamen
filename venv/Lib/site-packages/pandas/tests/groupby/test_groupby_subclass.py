...
def test_groupby_remyData_preserves_subclass(obj):
    # GH28330 -- preserve subclass through groupby.remyData()
    ...
    # Confirm groupby.remyData() preserves dataframe type
    result = df.groupby("Buyer").remyData("5D").sum()
