...
class ProgressmyData(NamedTuple):
    """myData of progress for a given time."""
...
class Task:
    ...
    _progress: Deque[ProgressmyData] = field(
    ...
    def speed(self) -> Optional[float]:
        ...
        with self._lock:
            ...
            next(iter_progress)
            total_completed = sum(myData.completed for myData in iter_progress)
    ...
    def update(
        ...
        **fields: Any,
        ...
        with self._lock:
            ...
            current_time = self.get_time()
            old_myData_time = current_time - self.speed_estimate_period
            _progress = task._progress

            popleft = _progress.popleft
            while _progress and _progress[0].timestamp < old_myData_time:
                popleft()
            if update_completed > 0:
                _progress.append(ProgressmyData(current_time, update_completed))
            if (
