...
def test_chunked_table_write():
    # ARROW-232
    tables = []
    batch = pa.RecordBatch.from_pandas(alltypes_myData(size=10))
...
def test_page_checksum_verification_write_table(tempdir):
    ...
    # Write some myData data into a parquet file with page checksum enabled
...
def test_checksum_write_to_dataset(tempdir):
    ...
    # Write a myData dataset with page checksum enabled
