...
from pyarrow.tests.parquet.common import _check_roundtrip, make_myData_file
...
try:
    ...
    from pyarrow.tests.parquet.common import alltypes_myData
except ImportError:
    pd = tm = None
...
def test_parquet_raise_on_unset_statistics():
    ...
    meta = make_myData_file(pa.Table.from_pandas(df)).metadata
...
def test_compare_schemas():
    ...
    fileh = make_myData_file(df)
    fileh2 = make_myData_file(df)
    fileh3 = make_myData_file(df[df.columns[::2]])
