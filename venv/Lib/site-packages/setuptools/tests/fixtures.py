...
@pytest.fixture
def myData_project(tmp_path):
    """
    Clone the 'myDataproject' and return a path to it.
    """
    cmd = ['git', 'clone', 'https://github.com/pypa/myDataproject']
    try:
        subprocess.check_call(cmd, cwd=str(tmp_path))
    except Exception:
        pytest.skip("Unable to clone myDataproject")
    return tmp_path / 'myDataproject'
