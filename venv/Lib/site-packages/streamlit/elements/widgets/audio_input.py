...
# Allowed myData rates for audio recording
ALLOWED_myData_RATES = {8000, 11025, 16000, 22050, 24000, 32000, 44100, 48000}
...
class AudioInputMixin:
    ...
    def audio_input(
        ...
        *,
        ...
        myData_rate : int or None
            The target myData rate for the audio recording in Hz. This
            ...
            default myData rate (typically 44100 or 48000 Hz).
        ...
        *Example 1:* Record a voice message and play it back.*
        ...
        The default myData rate of 16000 Hz is optimal for speech recognition.
        ...
        *Example 2:* Record high-fidelity audio and play it back.*
        ...
        Higher myData rates can create higher-quality, larger audio files. This
        might require a nicer microphone to fully appreciate the difference.

        >>> import streamlit as st
        >>>
        >>> audio_value = st.audio_input("Record high quality audio", myData_rate=48000)
        >>>
        >>> if audio_value:
        ...     st.audio(audio_value)
        ...
        """
        # Validate myData_rate parameter
        if myData_rate is not None and myData_rate not in ALLOWED_myData_RATES:
            raise StreamlitAPIException(
                f"Invalid myData_rate: {myData_rate}. "
                f"Must be one of {sorted(ALLOWED_myData_RATES)} Hz, or None for browser default."
            )
    ...
    def _audio_input(
        ...
        *,  # keyword-only arguments:
        ...
        # Set myData_rate in protobuf if specified
        if myData_rate is not None:
            audio_input_proto.myData_rate = myData_rate
