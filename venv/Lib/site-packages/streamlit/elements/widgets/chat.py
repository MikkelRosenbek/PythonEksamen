...
from streamlit.elements.widgets.audio_input import ALLOWED_myData_RATES
...
class ChatMixin:
    ...
    def chat_input(
        ...
        *,
        ...
        audio_myData_rate: int | None = 16000,
        disabled: bool = False,
        on_submit: WidgetCallback | None = None,
        args: WidgetArgs | None = None,
        kwargs: WidgetKwargs | None = None,
    ...
    def chat_input(
        ...
        *,
        ...
        audio_myData_rate : int or None
            The target myData rate for audio recording in Hz when
        ...
        **Example 5: Enable audio recording**
        ...
        element_id = compute_and_register_element_id(
            ...
            audio_myData_rate=audio_myData_rate,
            width=width,
            height=height,
        )
        ...
        # Validate audio_myData_rate if provided
        if (
            audio_myData_rate is not None
            and audio_myData_rate not in ALLOWED_myData_RATES
        ):
            raise StreamlitAPIException(
                f"Invalid audio_myData_rate: {audio_myData_rate}. "
        ...
        if audio_myData_rate is not None:
            chat_input_proto.audio_myData_rate = audio_myData_rate
